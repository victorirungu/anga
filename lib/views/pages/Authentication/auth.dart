...
import 'package:anga/views/pages/Authentication/components/login_form.dart';
import 'package:anga/views/pages/Authentication/components/sign_up_form.dart';
...
class Authentication extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    navigationController.activePage.value = "Login";
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Obx(() => Column(
                          children: [
                            dataController.signIn.value
                                ? LoginForm(width: width)
                                : SignUpForm(width: width),
                          ],
                        )),
