...
class CustomAppBarState extends State<CustomAppBar> {
  ...
  void _onScroll() {
    if (activeScrollController!.position.pixels <= 100) {
      setState(() {
        appBarColor = Colors.transparent;
        hasReachedTopThreshold = true;
      });
    } else if (activeScrollController!.position.pixels > 100) {
      setState(() {
        appBarColor = primaryBackGround().withOpacity(.95);
...
//     _dropdownOverlay =
//         _createDropdownOverlay(context, title, dropdownItems, width);
